namespace EIST.Repository.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<EIST.Repository.EISTDbContext>
    {
        ...
        protected override void Seed(EIST.Repository.EISTDbContext context)
        {
